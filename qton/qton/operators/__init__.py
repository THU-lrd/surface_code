...
def U (theta, phi, lamda, gamma): 
    return U_gate (params=[theta, phi, lamda, gamma]).represent
...
def CU (theta, phi, lamda, gamma): 
    return U_gate (params=[theta, phi, lamda, gamma], num_ctrls=1).represent
...
def CCU (theta, phi, lamda, gamma): 
    return U_gate (params=[theta, phi, lamda, gamma], num_ctrls=2).represent
